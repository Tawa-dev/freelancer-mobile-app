...
import 'package:freelancer/Jobs/job_details.dart';
            ...
            TextButton(
              onPressed: () async{
                try
                {
                  ...
                  {
                    GlobalMethod.showErrorDialogue(error: 'You cannot perform this action', ctx: ctx);
                  }
                }
                catch(error)
                {
                  GlobalMethod.showErrorDialogue(error: 'This task cannot be deleted', ctx: ctx);
                }finally{}
              },
              child: Row(
